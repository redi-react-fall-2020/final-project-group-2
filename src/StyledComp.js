...
export const Category = styled.div `
  align-items: center;
  background: ${(props) => (props.theme.mode === "dark" ? darkMode.secondary : lightMode.secondary)};
...
export const HeaderWarper = styled.div `
  background: ${(props) => (props.theme.mode === "dark" ? darkMode.header : lightMode.secondary)};
  display: flex;
  height: 127px;
  flex-direction: row;
  padding-left: 17px;
...
color: ${(props) => (props.theme.mode === "dark" ? darkMode.primary : lightMode.primary)};
background: ${(props) => (props.theme.mode === "dark" ? darkMode.imageUrl : lightMode.imageUrl)};
...
color: ${(props) => (props.theme.mode === "dark" ? darkMode.white  : lightMode.primary)};
background: ${(props) => (props.theme.mode === "dark" ? darkMode.secondary : lightMode.secondary)};
width: 694px;
height: 180px;
top: 266px;
...
export const HeadingText = styled.p `
  color: ${(props) => (props.theme.mode === "dark" ? darkMode.primary  : "#743434")};
  font-size: 49px;
  margin-bottom: 3rem;
  inline-height:33px;
  margin-top: 6rem;
...
export const Address = styled.input `
  ...
  height:100%;
  min-width: 100%;
  background: ${(props) => (props.theme.mode === "dark" ? darkMode.searchBar : lightMode.secondary)};
...
color: ${(props) => (props.theme.mode === "dark" ? darkMode.primary  : lightMode.primary)};
background-color: ${(props) => (props.theme.mode === "dark" ? darkMode.secondary  : lightMode.secondary)};
align-items: center;
display: flex;
...
color: ${(props) => (props.theme.mode === "dark" ? darkMode.orange  : lightMode.primary)};
object-fit: cover;
border-radius: 26px;
`;

export const ResturantGategoryTag = styled.div `
color: ${(props) => (props.theme.mode === "dark" ? darkMode.secondary  : lightMode.primary)};
background-color: ${(props) => (props.theme.mode === "dark" ? darkMode.primary  : lightMode.secondary)};
padding: 8px;
width: 66px;
height: 15px;
border-radius: 12px;
...
background: ${(props) => (props.theme.mode === "dark" ? darkMode.mapImageUrl  : lightMode.mapImageUrl)};
width:100%;
